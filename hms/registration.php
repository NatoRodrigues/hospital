	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2>HMS | Cadastro de paciente</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="clip-radio radio-primary">
									...
									<input type="radio" id="rg-male" name="gender" value="other">
									<label for="rg-male">
										Outro
									</label>
								</div>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control"  id="password_again" name="password_again" placeholder="Redigite sua senha" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> HMS</span>. <span>Todos os direitos reservados</span>
					</div>
