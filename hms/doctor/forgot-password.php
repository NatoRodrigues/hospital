	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php"><h2> HMS |  Recuperação de Senha do Médico</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
							Por favor, insira o número de contato e o e-mail registrados para recuperar sua senha.<br />
							...
							<div class="form-actions">
								...
								Resetar <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
					...
					<div class="copyright">
					<span class="text-bold text-uppercase"> Hospital HMS</span>
					</div>
