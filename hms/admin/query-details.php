...
<html lang="en">
	<head>
		<title>Admin | Detalhes da Consulta</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Detalhes da Consulta</h1>
																	</div>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gerenciar <span class="text-bold">Detalhes da Consulta</span></h5>
												<hr />
