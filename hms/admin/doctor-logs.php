...
<html lang="en">
	<head>
		<title>Admin | Registros de Sessões de Médicos</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Registros de Sessões de Médicos</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Registros de Sessões de Médicos</span>
									</li>
								</ol>
							</div>
						</section>
