	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> HMS | Entrar como paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Por favor insira seu nome de usuário e senha para logar.<br />
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"> Hospital HMS - Cuidando de você</span>.
					</div>
